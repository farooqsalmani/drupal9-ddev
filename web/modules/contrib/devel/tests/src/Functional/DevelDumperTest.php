...
//      $this->assertSession()->elementTextContains('xpath', '//input[@type="radio" and @name="dumper"]', $dumper);
//      if (in_array($dumper, $available_dumpers)) {
//        $this->assertSession()->elementTextContains('xpath', '//input[@name="dumper" and not(@disabled="disabled")]', $dumper);
//      }
//      else {
//        $this->assertSession()->elementTextContains('xpath', '//input[@name="dumper" and @disabled="disabled"]', $dumper);
//      }
//    }
    ...
    // $this->assertSession()->elementTextContains('xpath', '//input[@name="dumper"]', 'available_test_dumper');
    ...
    // $this->assertSession()->elementTextContains('xpath', '//input[@name="dumper" and not(@disabled="disabled")]', 'available_test_dumper'); // Available dumper input not is disabled.

    // $this->assertSession()->elementTextContains('xpath', '//input[@name="dumper"]', 'not_available_test_dumper');
    ...
    // $this->assertSession()->elementTextContains('xpath', '//input[@name="dumper" and @disabled="disabled"]', 'not_available_test_dumper'); // 'Non available dumper input is disabled.'
